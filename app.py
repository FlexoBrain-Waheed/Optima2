...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Anilox Mandrel Dimensions</strong></td><td class="highlight-adv">Massive (Base: 175.1 mm)</td><td class="highlight-mid">Standard (Base: 172.0 mm)</td><td class="highlight-dis">Base: 136.9 mm / OD: 159.1 mm</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>أبعاد أعمدة الأنيلوكس</strong></td><td class="highlight-adv">ضخمة (أساسي: 175.1 ملم) لمنع الاهتزاز</td><td class="highlight-mid">أبعاد قياسية (أساسي: 172.0 ملم)</td><td class="highlight-dis">أساسي 136.9 ملم / خارجي 159.1 ملم</td></tr>
...
# ==========================================
    ...
    if lang == "English":
        ...
        data = pd.DataFrame({
            'المعدة المطلوبة': ['كاميرا فحص 100%', 'وحدة كورونا + سحب (In-feed)', 'سليفات', 'تجهيزات طباعة ALU/PE', 'رافعات رولات (فك ولف)', 'دفاعة سليفات (Push-off)', 'وحدة طباعة متكررة (Insetter)'], 
...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">Critical Specification</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">The Winner 🏆</th></tr>
            <tr><td><strong>Training Program</strong></td><td class="highlight-adv" style="text-align: center;">10 Days + 2 Weeks + 1 Month</td><td style="text-align: center;">5 Days Only</td><td style="text-align: center;">Standard</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>مبادل حراري لتبريد الحبر</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ اختياري</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th></tr>
            <tr><td><strong>مجهزة للأنظمة الذكية</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم (مشمول)</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th></tr>
            <tr><td><strong>برنامج تدريب المشغلين</strong></td><td class="highlight-adv" style="text-align: center;">10 أيام + أسبوعين + شهر</td><td style="text-align: center;">5 أيام فقط</td><td style="text-align: center;">قياسي</td><td class="winner-cell">SOMA 🏆</td></tr>
