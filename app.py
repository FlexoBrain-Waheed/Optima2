...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Spare Parts Sourcing</strong></td><td class="highlight-adv">Open Source (Local procurement allowed)</td><td class="highlight-mid">Restricted (Smart sleeves mandated)</td><td class="highlight-dis">Restricted (Vendor procurement mandated)</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>العبء المالي لأنظمة التجهيز</strong></td><td class="highlight-adv">IRIS (مسح ضوئي، لا يوجد تكلفة إضافية مستمرة)</td><td class="highlight-mid">smartGPS (يتطلب شراء سليفات مدمجة بشرائح باهظة الثمن دائماً)</td><td class="highlight-dis">إعداد بصري كاميرات (هدر عالي في الخامات)</td></tr>
...
# ==========================================
    ...
    if lang == "English":
        ...
        st.markdown("""An objective comparison of SOMA's tactile topography mapping (IRIS) against BOBST's RFID-dependent (smartGPS) and W&H's traditional optical systems.""")
        ...
        <table class="corp-table">
            <tr>
                ...
                <th>BOBST (smartGPS)</th>
                <th>W&H (Optical Systems)</th>
            </tr>
            <tr>
                <td><strong>Measurement</strong></td>
                <td class="highlight-adv">Tactile sensors map physical plate topography</td>
                <td class="highlight-mid">Relies heavily on proprietary embedded RFID chips</td>
                <td class="highlight-dis">Optical reading / Manual input</td>
            </tr>
            <tr>
                <td><strong>Pre-Press QA</strong></td>
                <td class="highlight-adv">Generates exact TIR (Total Indicator Reading) report</td>
                <td class="highlight-mid">Chip-based registration data</td>
                <td class="highlight-dis">Standard visual inspection</td>
            </tr>
            <tr>
                <td><strong>OPEX Impact</strong></td>
                <td class="highlight-adv">Standard sleeves (Zero proprietary OPEX)</td>
                <td class="highlight-mid">Mandates highly expensive smart sleeves (High OPEX)</td>
                <td class="highlight-dis">Standard sleeves (High substrate setup waste)</td>
            </tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        df_waste = pd.DataFrame({
            'Setup Method': ['Traditional / Optical Setup', 'SOMA IRIS'],
        ...
        st.markdown("""مقارنة موضوعية بين نظام SOMA للطوبوغرافيا اللمسية (IRIS)، وبين نظام BOBST المعتمد على رقائق الـ RFID (smartGPS)، وأنظمة W&H البصرية التقليدية.""")
        ...
        <table class="corp-table">
            ...
            <tr>
                ...
                <td class="highlight-mid">تعتمد بشكل كامل على رقائق RFID مدمجة</td>
                <td class="highlight-dis">قراءة بصرية بالكاميرات / إدخال يدوي</td>
            </tr>
            <tr>
                <td><strong>فحص الجودة المسبق</strong></td>
                <td class="highlight-adv">إصدار تقرير (TIR) لتضاريس السليف قبل الطباعة</td>
                <td class="highlight-mid">بيانات تطابق مسجلة على الشريحة</td>
                <td class="highlight-dis">فحص بصري قياسي بالمطبعة</td>
            </tr>
            <tr>
                <td><strong>الأثر المالي (OPEX)</strong></td>
                <td class="highlight-adv">تستخدم سليفات عادية (لا توجد تكاليف تشغيلية إضافية)</td>
                <td class="highlight-mid">تُلزم المصنع بشراء سليفات ذكية باهظة الثمن دائماً (OPEX مرتفع جداً)</td>
                <td class="highlight-dis">تستخدم سليفات عادية (ولكن هدر الخامات أثناء الإعداد مرتفع جداً)</td>
            </tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        df_waste = pd.DataFrame({
            'طريقة الإعداد': ['الضبط التقليدي / البصري', 'نظام SOMA IRIS'],
