...
st.set_page_config(page_title="Executive Investment Proposal | NexFlexo", layout="wide", initial_sidebar_state="expanded")
...
# ==========================================
    ...
    if lang == "English":
        ...
        st.write("مقارنة صارمة للتفوق الميكانيكي والبرمجي الذي يضمن استقرار الطباعة (HD) ويقضي على الهدر اليومي.")
        st.markdown("""
        <table class="corp-table">
...
# ==========================================
    ...
    if lang == "English":
        ...
        st.write("NexFlexo offers a comprehensive, synchronized production line. Procuring all machinery from a single advanced ecosystem ensures seamless integration and qualifies Ymtaco for our highest tier of commercial discounts.")
        st.markdown("""
        <table class="corp-table">
        ...
        st.write("نحن في NexFlexo لا نبيع مجرد ماكينة مفردة، بل نبني لك مصنعاً متكاملاً بأعلى درجات التوافق التكنولوجي. شراء الحزمة الكاملة يمنح المصنع خصماً استثنائياً لا يمكن منافسته.")
        st.markdown("""
        <table class="corp-table">
...
# ==========================================
    ...
    if lang == "English":
        ...
        <div class="data-card-soma">
            ...
            <p>Conditional upon the procurement of the complete 4-machine suite, NexFlexo commits to an unprecedented training program:</p>
        ...
        """, unsafe_allow_html=True)
        st.markdown("""
        <div style="border: 3px solid #DC2626; padding: 30px; border-radius: 8px; background-color: #FEF2F2; margin-top: 30px; text-align: center;">
            <h2 style="color: #991B1B; margin-top:0;">⚔️ The Engineering Proof Challenge</h2>
            <p style="font-size: 1.3rem; color: #475569; line-height: 1.6;">
                ...
                <span style="color: #DC2626; font-weight: bold; font-size: 1.5rem;">Trust what you see, not just a brand name!</span>
            </p>
        </div>
        """, unsafe_allow_html=True)
    else:
        ...
        <div class="data-card-soma">
            ...
            <p style="font-size: 1.2rem;">في حال قراركم باعتماد المشروع المتكامل (الـ 4 ماكينات)، فإننا نقدم لكم باقة تدريب ضخمة ومجانية تشمل:</p>
        ...
        st.markdown("""
        <div style="border: 3px solid #DC2626; padding: 30px; border-radius: 8px; background-color: #FEF2F2; margin-top: 30px; text-align: center;">
            <h2 style="color: #991B1B; margin-top:0;">⚔️ دعوة للتحدي الميداني القاطع</h2>
            <p style="font-size: 1.3rem; color: #475569; line-height: 1.6;">
                ...
                <span style="color: #DC2626; font-weight: bold; font-size: 1.5rem;">استثماركم يستحق أن تختبروه بأنفسكم قبل التوقيع!</span>
            </p>
        </div>
        """, unsafe_allow_html=True)
