...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Machine Frame Material</strong></td><td class="highlight-adv">130 mm Cast-Iron (Vibration absorbing)</td><td class="highlight-mid">Standard Steel</td><td class="highlight-dis">55-60 mm Steel</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>مادة جدار الهيكل وسماكته</strong></td><td class="highlight-adv">حديد زهر (Cast-Iron) بسماكة 130 ملم</td><td class="highlight-mid">حديد صلب قياسي</td><td class="highlight-dis">حديد صلب 55-60 ملم</td></tr>
...
# ==========================================
    ...
    if lang == "English":
        ...
        with col1:
            ...
            * **SOMA S-Mount (Auto):** Est. 1.5 mins/color. (1,200 sleeves = **30 Hours/Month**). Single operator requirement. Equivalent to competitive systems costing over €220k.
            """)
...
# ==========================================
    ...
    if lang == "English":
        ...
        st.markdown("""
        <table class="corp-table">
            <tr><th style="width: 15%;">Machine Section</th><th style="width: 25%;">Critical Specification</th><th style="width: 15%; text-align: center;">SOMA Optima 2</th><th style="width: 15%; text-align: center;">BOBST Expert CI</th><th style="width: 15%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">The Winner 🏆</th></tr>
            
            <tr><td rowspan="8" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">1. Core Mechanics & Dimensions</td><td><strong>Max Production Speed</strong></td><td style="text-align: center;">600 m/min</td><td style="text-align: center;">500 m/min</td><td style="text-align: center;">500 m/min</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Print Repeat Range</strong></td><td style="text-align: center;">360 - 850 mm (up to 900)</td><td style="text-align: center;">370 - 800 mm</td><td style="text-align: center;">370 - 800 mm</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Web Tension Range</strong></td><td style="text-align: center;">10 - 400 N (Extended)</td><td style="text-align: center;">20 - 350 N</td><td style="text-align: center;">20 - 350 N</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Machine Frame Material</strong></td><td style="text-align: center;">130 mm Cast-Iron (Doubled)</td><td style="text-align: center;">Standard Steel</td><td style="text-align: center;">55 - 60 mm Steel</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Lightweight Winding Shafts</strong></td><td style="text-align: center;">✅ YES (Lighted 3" & 6")</td><td style="text-align: center;">❌ Optional</td><td style="text-align: center;">❌ NO</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Carbon Fiber Mandrels</strong></td><td style="text-align: center;">✅ Included</td><td style="text-align: center;">✅ Included</td><td style="text-align: center;">⚠️ Optional Upgrade</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>Anilox Base Mandrel Dia.</strong></td><td style="text-align: center;">175.1 mm (Max Stability)</td><td style="text-align: center;">172.0 mm</td><td style="text-align: center;">Standard / Smaller</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Anilox Circumference</strong></td><td style="text-align: center;">625 mm</td><td style="text-align: center;">630 mm</td><td style="text-align: center;">Standard</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>

            <tr><td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">2. Fluid & Thermal Management</td><td><strong>Viscosity Control (2 Liquids)</strong></td><td style="text-align: center;">✅ YES (Dual Liquid)</td><td style="text-align: center;">❌ NO (1 Liquid Only)</td><td style="text-align: center;">❌ NO (1 Liquid Only)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Ink/Solvent Level Sensors</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ Optional</td><td style="text-align: center;">❌ Optional</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Water Cooling on Drive Side</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ NO</td><td style="text-align: center;">❌ NO</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Heat Exchanger (Ink Cooling)</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ NO</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>Compressed Air Purifying Unit</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ Optional</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>Fast Wash Solvent Usage</strong></td><td style="text-align: center;">5 Liters</td><td style="text-align: center;">Standard</td><td style="text-align: center;">12 Liters</td><td class="winner-cell">SOMA 🏆</td></tr>

            <tr><td rowspan="8" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">3. Automation & Safety</td><td><strong>Prepared for Smart System</strong></td><td style="text-align: center;">✅ YES (Included)</td><td style="text-align: center;">❌ Optional</td><td style="text-align: center;">❌ NO</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Auto Impression & Register</strong></td><td style="text-align: center;">✅ Fully Auto (Falcon/BST)</td><td style="text-align: center;">⚠️ Semi-Auto (Smart-SET)</td><td style="text-align: center;">❌ Manual</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Sleeve Ejection System</strong></td><td style="text-align: center;">✅ Fully Auto Push-off</td><td style="text-align: center;">❌ NO / Semi-Auto</td><td style="text-align: center;">⚠️ Basic Ejectors</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Reprint / Insetter Capability</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ Missing (~10k)</td><td style="text-align: center;">❌ Missing (~10k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Fire Extinguishing System</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ Optional</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>Lifting Carts (Unwind & Rewind)</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ NO (Motorized only)</td><td style="text-align: center;">❌ NO</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Antistatic Units (Total)</strong></td><td style="text-align: center;">2 Units (4 Bars)</td><td style="text-align: center;">2 Units (4 Bars)</td><td style="text-align: center;">2 Units (4 Bars)</td><td class="winner-cell-tie">Standard Tie</td></tr>
            <tr><td><strong>100% Inspection Camera</strong></td><td style="text-align: center;">✅ Included (BST)</td><td style="text-align: center;">❌ Missing (~70k)</td><td style="text-align: center;">❌ Missing (~71k)</td><td class="winner-cell">SOMA 🏆</td></tr>

            <tr><td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">4. OPEX, Training & Peripherals</td><td><strong>Training Program</strong></td><td style="text-align: center;">10 Days + 2 Weeks + 1 Month</td><td style="text-align: center;">5 Days Only</td><td style="text-align: center;">Standard</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>3" & 6" Cores Included</strong></td><td style="text-align: center;">✅ YES (Both Included)</td><td style="text-align: center;">⚠️ 3" Only</td><td style="text-align: center;">⚠️ 3" Only</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Initial Sleeves (8+8)</strong></td><td style="text-align: center;">✅ Included</td><td style="text-align: center;">❌ Missing (~55k)</td><td style="text-align: center;">❌ Missing (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Corona + In-feed Unit</strong></td><td style="text-align: center;">✅ Included</td><td style="text-align: center;">❌ Missing (~55k)</td><td style="text-align: center;">❌ Missing (~55k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>ALU/PE Handling Kit</strong></td><td style="text-align: center;">✅ Included</td><td style="text-align: center;">❌ Missing (~50k)</td><td style="text-align: center;">❌ Missing (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Process Visibility (Glass)</strong></td><td style="text-align: center;">✅ Full Glass</td><td style="text-align: center;">⚠️ Partial</td><td style="text-align: center;">❌ Closed</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
    else:
        ...
        st.markdown("""
        <table class="corp-table">
            <tr><th style="width: 15%;">قطاع الماكينة</th><th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th><th style="width: 15%; text-align: center;">SOMA Optima 2</th><th style="width: 15%; text-align: center;">BOBST Expert CI</th><th style="width: 15%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th></tr>
            
            <tr><td rowspan="8" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">1. الهيكل الميكانيكي والأبعاد</td><td><strong>السرعة الإنتاجية القصوى</strong></td><td style="text-align: center;">600 متر/دقيقة</td><td style="text-align: center;">500 متر/دقيقة</td><td style="text-align: center;">500 متر/دقيقة</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>نطاق تكرار الطباعة (Repeat)</strong></td><td style="text-align: center;">360 - 850 ملم (إلى 900)</td><td style="text-align: center;">370 - 800 ملم</td><td style="text-align: center;">370 - 800 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>نطاق شد الرول (Web Tension)</strong></td><td style="text-align: center;">10 - 400 N (نطاق أوسع)</td><td style="text-align: center;">20 - 350 N</td><td style="text-align: center;">20 - 350 N</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>مادة وسماكة الهيكل (Frame)</strong></td><td style="text-align: center;">حديد زهر 130 ملم (مزدوج)</td><td style="text-align: center;">صلب قياسي</td><td style="text-align: center;">صلب 55 - 60 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أعمدة شد خفيفة الوزن (Shafts)</strong></td><td style="text-align: center;">✅ نعم (مضيئة 3 و 6 إنش)</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أعمدة كاربون فايبر للطباعة</strong></td><td style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">⚠️ ترقية اختيارية</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>القطر الخارجي لعمود الأنيلوكس</strong></td><td style="text-align: center;">175.1 ملم (استقرار مطلق)</td><td style="text-align: center;">172.0 ملم</td><td style="text-align: center;">قياسي / أصغر</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>محيط أسطوانة الأنيلوكس</strong></td><td style="text-align: center;">625 ملم</td><td style="text-align: center;">630 ملم</td><td style="text-align: center;">قياسي</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>

            <tr><td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">2. إدارة الحرارة والسوائل</td><td><strong>التحكم باللزوجة (لنوعين من السوائل)</strong></td><td style="text-align: center;">✅ نعم (مزدوج)</td><td style="text-align: center;">❌ لا (سائل واحد فقط)</td><td style="text-align: center;">❌ لا (سائل واحد فقط)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>حساسات مستوى الحبر والمذيبات</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ اختياري</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>التبريد المائي من جهة الإدارة</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ لا</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>مبادل حراري لتبريد الحبر</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ لا</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>وحدة تنقية الهواء المضغوط</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ اختياري</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>هدر المذيبات في الغسيل السريع</strong></td><td style="text-align: center;">5 لتر فقط</td><td style="text-align: center;">استهلاك قياسي</td><td style="text-align: center;">12 لتر (هدر عالي)</td><td class="winner-cell">SOMA 🏆</td></tr>

            <tr><td rowspan="8" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">3. الأتمتة وأنظمة الأمان</td><td><strong>مجهزة للأنظمة الذكية (مشمول بالسعر)</strong></td><td style="text-align: center;">✅ نعم (مشمول)</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أتمتة الضغوط والتطابق</strong></td><td style="text-align: center;">✅ آلي بالكامل (Falcon/BST)</td><td style="text-align: center;">⚠️ شبه آلي (Smart-SET)</td><td style="text-align: center;">❌ يدوي</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>نظام إخراج السليفات</strong></td><td style="text-align: center;">✅ دفع آلي (Push-off)</td><td style="text-align: center;">❌ لا / شبه آلي</td><td style="text-align: center;">⚠️ طاردات أساسية</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>تجهيز الطباعة المتكررة (Insetter)</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ غير مشمول (~10k)</td><td style="text-align: center;">❌ غير مشمول (~10k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>نظام إطفاء الحرائق</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ اختياري</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>رافعات رولات للفك واللف</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ لا (عربة آلية فقط)</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>وحدات منع الكهرباء الساكنة</strong></td><td style="text-align: center;">وحدتين (4 بارات)</td><td style="text-align: center;">وحدتين (4 بارات)</td><td style="text-align: center;">وحدتين (4 بارات)</td><td class="winner-cell-tie">تعادل قياسي</td></tr>
            <tr><td><strong>كاميرا فحص الجودة 100%</strong></td><td style="text-align: center;">✅ مشمولة (BST)</td><td style="text-align: center;">❌ غير مشمولة (~70k)</td><td style="text-align: center;">❌ غير مشمولة (~71k)</td><td class="winner-cell">SOMA 🏆</td></tr>

            <tr><td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">4. التشغيل والتدريب (OPEX)</td><td><strong>برنامج تدريب المشغلين</strong></td><td style="text-align: center;">10 أيام + أسبوعين + شهر</td><td style="text-align: center;">5 أيام فقط</td><td style="text-align: center;">قياسي</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>محاور مقاس 3 و 6 إنش (Cores)</strong></td><td style="text-align: center;">✅ نعم (كلاهما مشمول)</td><td style="text-align: center;">⚠️ 3 إنش فقط</td><td style="text-align: center;">⚠️ 3 إنش فقط</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أطقم السليفات المبدئية (8+8)</strong></td><td style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">❌ غير مشمولة (~55k)</td><td style="text-align: center;">❌ غير مشمولة (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>وحدة كورونا + وحدة سحب (In-feed)</strong></td><td style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">❌ غير مشمولة (~55k)</td><td style="text-align: center;">❌ غير مشمولة (~55k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>تجهيزات طباعة ALU و PE</strong></td><td style="text-align: center;">✅ مشمولة بالكامل</td><td style="text-align: center;">❌ غير مشمولة (~50k)</td><td style="text-align: center;">❌ غير مشمولة (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>رؤية وشفافية وحدات الطباعة</strong></td><td style="text-align: center;">✅ زجاج شفاف بالكامل</td><td style="text-align: center;">⚠️ أغطية جزئية</td><td style="text-align: center;">❌ مغلقة (انعدام الرؤية)</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
