...
# ==========================================
    ...
    if lang == "English":
        ...
        with col2:
            ...
            df_dry = pd.DataFrame({'Machine': ['SOMA Optima 2', 'W&H Alphaflex', 'BOBST Expert CI'], 'Length (m)': [6.0, 5.7, 4.5]})
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>مادة جدار الهيكل وسماكته</strong></td><td class="highlight-adv">حديد زهر (Cast-Iron) بسماكة 130 ملم</td><td class="highlight-mid">صلب 100 ملم</td><td class="highlight-dis">حديد صلب 55-60 ملم</td></tr>
        ...
        with col2:
            ...
            df_dry = pd.DataFrame({'الماكينة': ['SOMA Optima 2', 'BOBST Expert CI', 'W&H Alphaflex'], 'الطول (متر)': [6.0, 4.5, 5.7]})
            chart_dry = alt.Chart(df_dry).mark_bar(size=50).encode(
                x=alt.X('الماكينة:N', title='', sort=None),
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr>
                ...
                <td class="highlight-mid">4-10 Minutes / 16 Liters</td>
        ...
        <table class="corp-table">
            ...
            <tr>
                ...
                <td class="highlight-mid">4-10 دقائق / 16 لتر</td>
...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Deep Wash (Time / Solvent)</strong></td><td class="highlight-adv" style="text-align: center;">10 mins / 15 Liters</td><td style="text-align: center;">4-10 mins / 16 Liters</td><td style="text-align: center;">4-10 mins / 16 Liters</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Lifting Carts (Unwind/Rewind)</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ NO (Motorized only)</td><td style="text-align: center;">❌ NO</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>100% Inspection Camera</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included (BST)</td><td style="text-align: center;">❌ Missing (~70k)</td><td style="text-align: center;">❌ Missing (~71k)</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Initial Sleeves (8+8)</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included</td><td style="text-align: center;">❌ Missing (~55k)</td><td style="text-align: center;">❌ Missing (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Corona + In-feed Unit</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included</td><td style="text-align: center;">❌ Missing (~55k)</td><td style="text-align: center;">❌ Missing (~55k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>ALU/PE Handling Kit</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included</td><td style="text-align: center;">❌ Missing (~50k)</td><td style="text-align: center;">❌ Missing (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>مادة وسماكة الهيكل (Frame)</strong></td><td class="highlight-adv" style="text-align: center;">حديد زهر 130 ملم (مزدوج)</td><td style="text-align: center;">صلب 100 ملم</td><td style="text-align: center;">صلب 55 - 60 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>دورة الغسيل العميق (وقت/استهلاك)</strong></td><td class="highlight-adv" style="text-align: center;">10 دقائق / 15 لتر</td><td style="text-align: center;">4-10 دقائق / 16 لتر</td><td style="text-align: center;">4-10 دقائق / 16 لتر</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>أتمتة الضغوط والتطابق</strong></td><td class="highlight-adv" style="text-align: center;">✅ آلي بالكامل (Falcon/BST)</td><td style="text-align: center;">⚠️ شبه آلي (Smart-SET)</td><td style="text-align: center;">❌ يدوي</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>تجهيز الطباعة المتكررة (Insetter)</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ غير مشمول (~10k)</td><td style="text-align: center;">❌ غير مشمول (~10k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>رافعات رولات للفك واللف</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ لا (عربة آلية فقط)</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>كاميرا فحص الجودة 100%</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة (BST)</td><td style="text-align: center;">❌ غير مشمولة (~70k)</td><td style="text-align: center;">❌ غير مشمولة (~71k)</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>أطقم السليفات المبدئية (8+8)</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">❌ غير مشمولة (~55k)</td><td style="text-align: center;">❌ غير مشمولة (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>وحدة كورونا + وحدة سحب (In-feed)</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">❌ غير مشمولة (~55k)</td><td style="text-align: center;">❌ غير مشمولة (~55k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>تجهيزات طباعة ALU و PE</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة بالكامل</td><td style="text-align: center;">❌ غير مشمولة (~50k)</td><td style="text-align: center;">❌ غير مشمولة (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
