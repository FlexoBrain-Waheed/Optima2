    ...
    if lang == "English":
        ...
        <div class="data-card">
            ...
            <ul style="line-height: 1.8; font-size: 1.1rem; color: #334155;">
                <li><b>Competitor Benchmark (BOBST & W&H):</b> Offers only 5 days of basic training.</li>
        ...
        <div class="data-card">
            ...
            <ul style="line-height: 1.8; font-size: 1.1rem; color: #334155;">
                <li><b>المنافسين (BOBST و W&H):</b> 5 أيام فقط من التدريب الأساسي.</li>
...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">Critical Specification</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">The Winner 🏆</th></tr>
            <tr><td><strong>Training Program</strong></td><td class="highlight-adv" style="text-align: center;">10 Days + 2 Weeks + 1 Month</td><td style="text-align: center;">5 Days Only</td><td style="text-align: center;">5 Days Only</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th></tr>
            <tr><td><strong>برنامج تدريب المشغلين</strong></td><td class="highlight-adv" style="text-align: center;">10 أيام + أسبوعين + شهر</td><td style="text-align: center;">5 أيام فقط</td><td style="text-align: center;">5 أيام فقط</td><td class="winner-cell">SOMA 🏆</td></tr>
