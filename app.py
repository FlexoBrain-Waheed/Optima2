...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Anilox Mandrel Dimensions</strong></td><td class="highlight-adv">Massive (Diam. 175.1 mm / Perim. 625 mm)</td><td class="highlight-dis">Standard / Smaller Dimensions</td><td>Larger perimeter acts as a stabilizing core, drastically reducing flex and bouncing at maximum speeds.</td></tr>
            <tr><td><strong>ALU & PE Film Processing</strong></td><td class="highlight-adv">Dedicated In/Out-feed, MINK Spreader & Hard Anodized Rollers</td><td class="highlight-dis">Standard setup (No special equipment)</td><td>Guarantees flawless tension control, preventing PE wrinkling and protecting rollers from abrasive ALU wear.</td></tr>
            ...
            <tr><td><strong>Sleeve Ejection System</strong></td><td class="highlight-adv">Fully Automatic Push-off</td><td class="highlight-dis">Basic Ejectors</td><td>Ensures effortless removal of sleeves, drastically reducing operator fatigue and preventing sleeve damage.</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>أبعاد أعمدة الأنيلوكس (Anilox Mandrels)</strong></td><td class="highlight-adv">ضخمة (القطر: 175.1 ملم / المحيط: 625 ملم)</td><td class="highlight-dis">حجم قياسي / أصغر</td><td>المحيط الأكبر يعمل كمركز ثقل هائل يمنع أي انحناء أو اهتزاز على السرعات القصوى، مما يضمن استقراراً مطلقاً للطباعة.</td></tr>
            <tr><td><strong>تجهيزات طباعة الألمنيوم (ALU) و(PE)</strong></td><td class="highlight-adv">وحدات شد مخصصة (In/Out-feed)، رولات فرد (MINK)، ورولات (Anodized)</td><td class="highlight-dis">مسار قياسي (بدون تجهيزات خاصة)</td><td>يضمن تحكماً دقيقاً بالشد، ويمنع تجعد أفلام PE البلاستيكية وتآكل الألمنيوم تماماً.</td></tr>
            ...
            <tr><td><strong>نظام إخراج السليفات (Ejection System)</strong></td><td class="highlight-adv">نظام دفع أوتوماتيكي بالكامل</td><td class="highlight-dis">طاردات أساسية تقليدية</td><td>يضمن إزالة السليفات بأمان وبدون أي مجهود بدني، مما يمنع تلفها ويحمي المشغل.</td></tr>
...
# ==========================================
    ...
    if lang == "English":
        ...
        data = pd.DataFrame({'Missing Component': ['ITS Cooling', '100% Camera', 'Sleeves & Aniloxes', 'Carbon Mandrels', 'ALU/PE Handling Kit', 'Roll Lift'], 'Estimated Cost (€)': [50000, 71000, 50000, 30000, 50000, 15000]})
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>ALU & PE Handling Kit (In/Out-feed, MINK, Anodized)</strong></td><td class="highlight-adv">✅ Standard Inclusion</td><td class="highlight-dis">❌ Missing (Basic setup)</td><td><strong>~ € 50,000</strong></td></tr>
        ...
        """, unsafe_allow_html=True)
        st.error("📉 **Financial Conclusion:** The Alphaflex base price is deceptive. To elevate it to the operational standard of the Optima 2, Ymtaco would incur over **€ 250,000** in hidden capital expenditures.")
        ...
        data = pd.DataFrame({'الإضافة المطلوبة': ['نظام تبريد الحبر (ITS)', 'كاميرا فحص 100%', 'سليفات وأنيلوكس', 'ترقية أعمدة الكاربون', 'تجهيزات طباعة ALU/PE', 'رافعة الرولات'], 'التكلفة التقديرية (يورو)': [50000, 71000, 50000, 30000, 50000, 15000]})
        chart = alt.Chart(data).mark_bar(color='#DC2626', cornerRadiusEnd=4).encode(
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>تجهيزات طباعة ALU و PE (In/Out-feed, MINK)</strong></td><td class="highlight-adv">✅ مواصفة قياسية أساسية</td><td class="highlight-dis">❌ غير مشمولة (إعداد أساسي فقط)</td><td><strong>~ € 50,000</strong></td></tr>
        ...
        """, unsafe_allow_html=True)
        st.error("📉 **الخلاصة المالية:** السعر الأساسي لماكينة Alphaflex خادع مالياً. للوصول بها إلى المستوى التشغيلي القياسي لماكينة Optima 2، سيتكبد المصنع أكثر من **250,000 يورو** كإضافات حتمية.")
