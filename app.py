...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Out-feed Unit</strong></td><td class="highlight-adv">✔️ Included</td><td class="highlight-mid">❌ Optional</td><td class="highlight-dis">❌ Optional</td></tr>
        ...
        """, unsafe_allow_html=True)
        st.info("📊 **Financial Note:** The initial CAPEX of the competitor base models requires critical adjustment. Aligning the BOBST Expert CI to SOMA's standard involves massive mandatory hardware additions.")
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>وحدة السحب بعد الطباعة (Out-feed)</strong></td><td class="highlight-adv">✔️ مشمولة بالكامل</td><td class="highlight-mid">❌ ترقية اختيارية</td><td class="highlight-dis">❌ ترقية اختيارية</td></tr>
        ...
        """, unsafe_allow_html=True)
        st.info("📊 **الخلاصة المالية (الصدمة):** العروض المنافسة قدمت ماكينة بهيكل مجرد لتبدو أرخص. لتصل ماكينة BOBST لمستوى التجهيز القياسي في SOMA، سيتكبد المصنع مبالغ هائلة إضافية كحد أدنى لسد النواقص التشغيلية.")
...
# ==========================================
    ...
    if lang == "English":
        ...
        st.markdown("""يعتمد كل من نظام SOMA IRIS ونظام BOBST smartGPS على **شرائح RFID ومغانط** مدمجة في السليفات لنقل بيانات المونتاج إلى المطبعة. لكن الفارق الجوهري والخطير يكمن في **طريقة أخذ القياسات الفعلية** أثناء التجهيز، و **طريقة وتوقيت نقل البيانات إلى المطبعة.**""")
...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Lightweight Winding Shafts</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES (Lighted 3" & 6")</td><td style="text-align: center;">❌ Optional</td><td style="text-align: center;">❌ Optional</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Auto Impression & Register</strong></td><td class="highlight-adv" style="text-align: center;">✅ Fully Auto with IRIS Mounter</td><td style="text-align: center;">⚠️ Semi-Auto (Smart-SET)</td><td style="text-align: center;">❌ Semi-Auto</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>RFID Data Transfer Workflow</strong></td><td class="highlight-adv" style="text-align: center;">✅ Instant Pre-mount Read</td><td style="text-align: center;">❌ ~10 Min Scan Cycle (Post-mount)</td><td style="text-align: center;">❌ Manual / N/A</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>Rolls Lifting (Unwind/Rewind)</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES</td><td style="text-align: center;">⚠️ Optional Upgrade</td><td style="text-align: center;">⚠️ Optional Upgrade</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>أعمدة شد خفيفة الوزن (Shafts)</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم (مضيئة 3 و 6 إنش)</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ اختياري</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>وحدة تنقية الهواء المضغوط</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ ترقية اختيارية</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>طريقة نقل بيانات السليف (RFID)</strong></td><td class="highlight-adv" style="text-align: center;">✅ قراءة فورية قبل التركيب (0 تأخير)</td><td style="text-align: center;">❌ فحص متأخر لـ 10 دقائق (معرض للفشل)</td><td style="text-align: center;">❌ غير متوفر / يدوي</td><td class="winner-cell">SOMA 🏆</td></tr>
