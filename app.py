...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr>
                <td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">1. Core Mechanics & Dimensions</td>
            ...
            <tr>
                ...
                <td style="text-align: center;">✅ Included</td>
                <td style="text-align: center;">⚠️ Optional Upgrade</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            </tr>
            <tr>
                <td><strong>Anilox Base Mandrel Dia.</strong></td>
                <td style="text-align: center;">175.1 mm (Max Stability)</td>
                <td style="text-align: center;">172.0 mm</td>
                <td style="text-align: center;">Standard / Smaller</td>
                <td class="winner-cell">SOMA 🏆</td>
            </tr>
            <tr>
                <td><strong>Anilox Circumference</strong></td>
                <td style="text-align: center;">625 mm</td>
                <td style="text-align: center;">630 mm</td>
                <td style="text-align: center;">Standard</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            </tr>
            <tr>
                <td><strong>Web Tension Range</strong></td>
                <td style="text-align: center;">20 - 350 N</td>
                <td style="text-align: center;">20 - 350 N</td>
                <td style="text-align: center;">20 - 350 N</td>
                <td class="winner-cell-tie">Standard Tie</td>
            </tr>

            <tr>
                <td rowspan="5" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">2. Fluid & Thermal Management</td>
                <td><strong>Viscosity Control (2 Liquids)</strong></td>
                <td style="text-align: center;">✅ YES (Dual Liquid)</td>
                <td style="text-align: center;">❌ NO (1 Liquid Only)</td>
                <td style="text-align: center;">❌ NO (1 Liquid Only)</td>
                <td class="winner-cell">SOMA 🏆</td>
            </tr>
            <tr>
                <td><strong>Heat Exchanger (Ink Cooling)</strong></td>
            ...
            <tr>
                <td><strong>Compressed Air Purifying Unit</strong></td>
                <td style="text-align: center;">✅ YES</td>
                <td style="text-align: center;">✅ YES</td>
            ...
            <tr>
                ...
                <td style="text-align: center;">6.0 Meters (23 Nozzles)</td>
            ...
            <tr>
                <td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">3. Automation & Safety</td>
                <td><strong>Prepared for Smart System</strong></td>
                <td style="text-align: center;">✅ YES (IRIS)</td>
                <td style="text-align: center;">✅ YES (smartGPS)</td>
                <td style="text-align: center;">❌ NO</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            </tr>
            <tr>
                ...
                <td style="text-align: center;">❌ NO / Semi-Auto</td>
                <td style="text-align: center;">⚠️ Basic Ejectors</td>
                <td class="winner-cell">SOMA 🏆</td>
            </tr>
            <tr>
                <td><strong>Fire Extinguishing System</strong></td>
                <td style="text-align: center;">✅ YES</td>
                <td style="text-align: center;">✅ YES</td>
                <td style="text-align: center;">❌ Optional</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            ...
            <tr>
                <td><strong>Lifting Carts (Unwind & Rewind)</strong></td>
                <td style="text-align: center;">✅ YES</td>
                <td style="text-align: center;">✅ YES</td>
                <td style="text-align: center;">❌ NO</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            ...
            <tr>
                <td><strong>Antistatic Units (Total)</strong></td>
                <td style="text-align: center;">2 Units (4 Bars)</td>
                <td style="text-align: center;">2 Units (4 Bars)</td>
                <td style="text-align: center;">2 Units (4 Bars)</td>
                <td class="winner-cell-tie">Standard Tie</td>
            </tr>
            ...
            <tr>
                <td rowspan="4" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">4. OPEX & Peripherals</td>
                <td><strong>Initial Sleeves (8+8)</strong></td>
                <td style="text-align: center;">✅ Included (Standard)</td>
                <td style="text-align: center;">⚠️ Requires costly smartGPS</td>
            ...
            <tr>
                ...
                <td style="text-align: center;">✅ Full Glass</td>
        ...
        <table class="corp-table">
            <tr>
                ...
                <th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th>
                <th style="width: 15%; text-align: center;">SOMA Optima 2</th>
                <th style="width: 15%; text-align: center;">BOBST Expert CI</th>
                <th style="width: 15%; text-align: center;">W&H Alphaflex</th>
                <th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th>
            </tr>
            
            <tr>
                <td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">1. الهيكل الميكانيكي والأبعاد</td>
            ...
            <tr>
                ...
                <td style="text-align: center;">✅ مشمولة</td>
                <td style="text-align: center;">⚠️ ترقية اختيارية</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            </tr>
            <tr>
                <td><strong>القطر الخارجي لعمود الأنيلوكس</strong></td>
                <td style="text-align: center;">175.1 ملم (استقرار مطلق)</td>
                <td style="text-align: center;">172.0 ملم</td>
                <td style="text-align: center;">قياسي / أصغر</td>
                <td class="winner-cell">SOMA 🏆</td>
            </tr>
            <tr>
                <td><strong>محيط أسطوانة الأنيلوكس</strong></td>
                <td style="text-align: center;">625 ملم</td>
                <td style="text-align: center;">630 ملم</td>
                <td style="text-align: center;">قياسي</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            </tr>
            <tr>
                <td><strong>نطاق شد الرول (Web Tension)</strong></td>
                <td style="text-align: center;">20 - 350 N</td>
                <td style="text-align: center;">20 - 350 N</td>
                <td style="text-align: center;">20 - 350 N</td>
                <td class="winner-cell-tie">تعادل قياسي</td>
            </tr>

            <tr>
                <td rowspan="5" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">2. إدارة الحرارة والسوائل</td>
                <td><strong>التحكم باللزوجة (لنوعين من السوائل)</strong></td>
                <td style="text-align: center;">✅ نعم (مزدوج)</td>
                <td style="text-align: center;">❌ لا (سائل واحد فقط)</td>
                <td style="text-align: center;">❌ لا (سائل واحد فقط)</td>
                <td class="winner-cell">SOMA 🏆</td>
            </tr>
            <tr>
                <td><strong>مبادل حراري لتبريد الحبر</strong></td>
                <td style="text-align: center;">✅ نعم</td>
                <td style="text-align: center;">✅ نعم</td>
                <td style="text-align: center;">❌ لا</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            </tr>
            <tr>
                <td><strong>وحدة تنقية الهواء المضغوط</strong></td>
                <td style="text-align: center;">✅ نعم</td>
                <td style="text-align: center;">✅ نعم</td>
                <td style="text-align: center;">❌ اختياري</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            </tr>
            <tr>
                <td><strong>طول نفق التجفيف</strong></td>
                <td style="text-align: center;">6.0 أمتار (23 فوهة)</td>
            ...
            <tr>
                <td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">3. الأتمتة وأنظمة الأمان</td>
                <td><strong>مجهزة للأنظمة الذكية (IRIS/GPS)</strong></td>
                <td style="text-align: center;">✅ نعم (IRIS)</td>
                <td style="text-align: center;">✅ نعم (smartGPS)</td>
                <td style="text-align: center;">❌ لا</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            </tr>
            <tr>
                <td><strong>نظام إخراج السليفات</strong></td>
                <td style="text-align: center;">✅ دفع آلي (Push-off)</td>
                <td style="text-align: center;">❌ لا / شبه آلي</td>
                <td style="text-align: center;">⚠️ طاردات أساسية</td>
                <td class="winner-cell">SOMA 🏆</td>
            </tr>
            <tr>
                <td><strong>نظام إطفاء الحرائق</strong></td>
                <td style="text-align: center;">✅ نعم</td>
                <td style="text-align: center;">✅ نعم</td>
                <td style="text-align: center;">❌ اختياري</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            ...
            <tr>
                <td><strong>رافعة رولات للفك واللف</strong></td>
                <td style="text-align: center;">✅ نعم</td>
                <td style="text-align: center;">✅ نعم</td>
                <td style="text-align: center;">❌ لا</td>
                <td class="winner-cell-shared">SOMA & BOBST</td>
            ...
            <tr>
                <td><strong>وحدات منع الكهرباء الساكنة</strong></td>
                <td style="text-align: center;">وحدتين (4 بارات)</td>
                <td style="text-align: center;">وحدتين (4 بارات)</td>
                <td style="text-align: center;">وحدتين (4 بارات)</td>
                <td class="winner-cell-tie">تعادل قياسي</td>
            </tr>
            ...
            <tr>
                <td rowspan="4" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">4. التكاليف التشغيلية (OPEX)</td>
                <td><strong>أطقم السليفات المبدئية (8+8)</strong></td>
                <td style="text-align: center;">✅ مشمولة (قياسية)</td>
                <td style="text-align: center;">⚠️ تتطلب شراء smartGPS مكلفة</td>
            ...
            <tr>
                ...
                <td style="text-align: center;">⚠️ أغطية جزئية</td>
                <td style="text-align: center;">❌ مغلقة (انعدام الرؤية)</td>
                <td class="winner-cell">SOMA 🏆</td>
            </tr>
            <tr>
                <td><strong>فترة الضمان الإجمالية</strong></td>
                <td style="text-align: center;">12 شهراً</td>
                <td style="text-align: center;">12 شهراً</td>
                <td style="text-align: center;">12 شهراً</td>
                <td class="winner-cell-tie">تعادل قياسي</td>
            </tr>
