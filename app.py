...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Machine Frame Material</strong></td><td class="highlight-adv">130 mm Cast-Iron (Vibration absorbing)</td><td class="highlight-mid">100 mm Cast-Iron</td><td class="highlight-dis">55-60 mm Steel</td></tr>
            <tr><td><strong>Printing Unit Calibration</strong></td><td class="highlight-adv">Fully Auto (Zero Tools/Human Intervention)</td><td class="highlight-mid">Periodic Manual (Needs tools)</td><td class="highlight-dis">Manual</td></tr>
            <tr><td><strong>Printing Deck Capping</strong></td><td class="highlight-adv">Fully Auto (High-Tech Mechanism)</td><td class="highlight-mid">Complex (Screws & doors, needs maintenance)</td><td class="highlight-dis">Automatic</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>مادة جدار الهيكل وسماكته</strong></td><td class="highlight-adv">حديد زهر (Cast-Iron) بسماكة 130 ملم</td><td class="highlight-mid">حديد زهر 100 ملم</td><td class="highlight-dis">حديد صلب 55-60 ملم</td></tr>
            <tr><td><strong>معايرة وحدات الطباعة (Calibration)</strong></td><td class="highlight-adv">آلي بالكامل (بدون تدخل بشري أو أدوات)</td><td class="highlight-mid">يدوي دوري (يتطلب أدوات وتدخل بشري)</td><td class="highlight-dis">يدوي</td></tr>
            <tr><td><strong>إغلاق وحدات الطباعة (Capping)</strong></td><td class="highlight-adv">آلي بالكامل بتقنية عالية</td><td class="highlight-mid">معقد (براغي وأبواب، يتطلب صيانة دورية)</td><td class="highlight-dis">آلي</td></tr>
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            <tr>
                ...
                <th>BOBST Expert CI (smartWASH)</th>
            ...
            <tr>
                ...
                <td class="highlight-mid">10 Minutes / 16 Liters</td>
                <td class="highlight-dis">4 mins / 16 Liters</td>
            </tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            ...
            <tr>
                ...
                <td class="highlight-mid">10 دقائق / 16 لتر</td>
                <td class="highlight-dis">4 دقائق / 16 لتر</td>
            </tr>
        </table>
        """, unsafe_allow_html=True)
...
# ==========================================
    ...
    if lang == "English":
        ...
        data = pd.DataFrame({
            'Equipment Add-on': ['100% Camera', 'Corona + In-feed Unit', 'Sleeves & Aniloxes', 'ALU/PE Kit (Spreader)', 'Out-feed Unit', 'Lifts (Unwind/Rewind)', 'Push-off Device', 'Insetter (Reprint)'], 
            'Estimated Value (€)': [70000, 55000, 55000, 50000, 55000, 30000, 20000, 10000]
        })
        chart = alt.Chart(data).mark_bar(color='#64748B', cornerRadiusEnd=4).encode(
            x=alt.X('Estimated Value (€):Q', title='Estimated Optional Upgrades Value (€)'), y=alt.Y('Equipment Add-on:N', sort='-x', title=''), tooltip=['Equipment Add-on', 'Estimated Value (€)']
        ).properties(height=350, title="Valuation of Optional Add-ons for BOBST Expert CI")
        st.altair_chart(chart, use_container_width=True)

        st.markdown("""
        <table class="corp-table">
            <tr><th>Operational Requirement</th><th>SOMA Optima 2</th><th>BOBST Expert CI</th><th>W&H Alphaflex</th></tr>
            <tr><td><strong>Initial Sleeves (8)</strong></td><td class="highlight-adv">✔️ Included</td><td class="highlight-mid">⚠️ Optional (~ €55k)</td><td class="highlight-dis">⚠️ Optional (~ €50k)</td></tr>
            <tr><td><strong>100% Inspection Camera</strong></td><td class="highlight-adv">✔️ Included (BST)</td><td class="highlight-mid">⚠️ Optional (~ €70k)</td><td class="highlight-dis">⚠️ Optional (~ €71k)</td></tr>
            <tr><td><strong>Corona + In-feed Unit (PE Control)</strong></td><td class="highlight-adv">✔️ Included</td><td class="highlight-mid">⚠️ Optional (~ €55k)</td><td class="highlight-dis">⚠️ Optional (~ €55k)</td></tr>
            <tr><td><strong>Out-feed Unit</strong></td><td class="highlight-adv">✔️ Included</td><td class="highlight-mid">⚠️ Optional</td><td class="highlight-dis">⚠️ Optional</td></tr>
            <tr><td><strong>ALU/PE Handling Kit (Spreader)</strong></td><td class="highlight-adv">✔️ Included</td><td class="highlight-mid">⚠️ Optional (~ €50k)</td><td class="highlight-dis">⚠️ Optional (~ €50k)</td></tr>
            <tr><td><strong>Roll Lifts on Unwind/Rewind</strong></td><td class="highlight-adv">✔️ Included</td><td class="highlight-mid">⚠️ Optional (~ €30k)</td><td class="highlight-dis">⚠️ Optional (~ €15k)</td></tr>
            <tr><td><strong>Sleeve Push-off Device</strong></td><td class="highlight-adv">✔️ Included</td><td class="highlight-mid">⚠️ Optional (~ €20k)</td><td class="highlight-dis">⚠️ Optional (~ €20k)</td></tr>
            <tr><td><strong>Reprint / Insetter Capability</strong></td><td class="highlight-adv">✔️ Included</td><td class="highlight-mid">⚠️ Optional (~ €10k)</td><td class="highlight-dis">⚠️ Optional (~ €10k)</td></tr>
        </table>
        """, unsafe_allow_html=True)
        st.info("📊 **Financial Note:** The initial CAPEX of the competitor base models requires critical adjustment. Aligning the BOBST Expert CI to SOMA's standard involves massive optional hardware additions.")
    
    else:
        st.markdown('<div class="executive-title">5. تحليل التكلفة الإجمالية للملكية (TCO) والتجهيزات الاختيارية</div>', unsafe_allow_html=True)
        st.markdown("""مواءمة مالية تفصيلية تحلل العروض المبدئية المجردة مقابل الإضافات الاختيارية المطلوبة لتحقيق قدرة تشغيلية متكافئة لخط الإنتاج.""")
        
        data = pd.DataFrame({
            'المعدة المطلوبة': ['كاميرا فحص 100%', 'وحدة كورونا + سحب (In-feed)', 'سليفات وأنيلوكس', 'وحدة السحب (Out-feed)', 'تجهيزات طباعة ALU/PE', 'رافعات رولات (فك ولف)', 'دفاعة سليفات (Push-off)', 'وحدة طباعة متكررة (Insetter)'], 
            'القيمة التقديرية (يورو)': [70000, 55000, 55000, 55000, 50000, 30000, 20000, 10000]
        })
        chart = alt.Chart(data).mark_bar(color='#64748B', cornerRadiusEnd=4).encode(
            x=alt.X('القيمة التقديرية (يورو):Q', title='قيمة الإضافات الاختيارية (يورو)'), y=alt.Y('المعدة المطلوبة:N', sort='-x', title=''), tooltip=['المعدة المطلوبة', 'القيمة التقديرية (يورو)']
        ).properties(height=350, title="تكلفة التجهيزات الاختيارية في عرض BOBST لتطابق مواصفات SOMA")
        st.altair_chart(chart, use_container_width=True)

        st.markdown("""
        <table class="corp-table">
            <tr><th>المتطلب التشغيلي</th><th>SOMA Optima 2</th><th>BOBST Expert CI</th><th>W&H Alphaflex</th></tr>
            <tr><td><strong>أطقم السليفات المبدئية (8)</strong></td><td class="highlight-adv">✔️ مشمولة بالكامل</td><td class="highlight-mid">⚠️ اختياري (~ €55,000)</td><td class="highlight-dis">⚠️ اختياري (~ €50,000)</td></tr>
            <tr><td><strong>كاميرا فحص الجودة 100%</strong></td><td class="highlight-adv">✔️ مشمولة (BST iPQ)</td><td class="highlight-mid">⚠️ اختياري (~ €70,000)</td><td class="highlight-dis">⚠️ اختياري (~ €71,000)</td></tr>
            <tr><td><strong>وحدة كورونا + In-feed (لضبط طباعة PE)</strong></td><td class="highlight-adv">✔️ مشمولة بالكامل</td><td class="highlight-mid">⚠️ اختياري (~ €55,000)</td><td class="highlight-dis">⚠️ اختياري (~ €55,000)</td></tr>
            <tr><td><strong>وحدة السحب بعد الطباعة (Out-feed)</strong></td><td class="highlight-adv">✔️ مشمولة بالكامل</td><td class="highlight-mid">⚠️ اختياري</td><td class="highlight-dis">⚠️ اختياري</td></tr>
            <tr><td><strong>تجهيزات طباعة ALU و PE</strong></td><td class="highlight-adv">✔️ مشمولة بالكامل</td><td class="highlight-mid">⚠️ اختياري (~ €50,000)</td><td class="highlight-dis">⚠️ اختياري (~ €50,000)</td></tr>
            <tr><td><strong>رافعات رولات هيدروليكية (للفك واللف)</strong></td><td class="highlight-adv">✔️ مشمولة بالكامل</td><td class="highlight-mid">⚠️ اختياري (~ €30,000)</td><td class="highlight-dis">⚠️ اختياري (~ €15,000)</td></tr>
            <tr><td><strong>نظام الدفع الآلي للسليفات (Push-off)</strong></td><td class="highlight-adv">✔️ مشمولة بالكامل</td><td class="highlight-mid">⚠️ اختياري (~ €20,000)</td><td class="highlight-dis">⚠️ اختياري (~ €20,000)</td></tr>
            <tr><td><strong>تجهيز الطباعة المتكررة (Reprint/Insetter)</strong></td><td class="highlight-adv">✔️ مشمولة بالكامل</td><td class="highlight-mid">⚠️ اختياري (~ €10,000)</td><td class="highlight-dis">⚠️ اختياري (~ €10,000)</td></tr>
        </table>
        """, unsafe_allow_html=True)
        st.info("📊 **الخلاصة المالية:** العروض المنافسة قدمت ماكينة بهيكل مجرد. لتصل ماكينة BOBST لمستوى التجهيز القياسي في SOMA، سيتكبد المصنع مبالغ هائلة إضافية كحد أدنى لسد هذه المتطلبات الاختيارية.")
    ...
    if lang == "English":
        ...
        <div class="data-card">
            ...
            <ul style="line-height: 1.8; font-size: 1.1rem; color: #334155;">
                <li><b>Competitor Benchmark (BOBST & W&H):</b> Offers only 5 days of basic training (often an optional extra cost for W&H).</li>
        ...
        <div class="data-card">
            ...
            <ul style="line-height: 1.8; font-size: 1.1rem; color: #334155;">
                <li><b>المنافسين (BOBST و W&H):</b> 5 أيام فقط من التدريب (واختياري بتكلفة إضافية في W&H).</li>
...
# ==========================================
    ...
    if lang == "English":
        ...
        st.markdown("""Both SOMA IRIS and BOBST smartGPS utilize embedded RFID chips and magnets in the sleeves to transfer offline mounting data to the press. However, the critical differentiation lies in **how the data is physically measured** at the mounter, and **how fast the data transfers to the press.**""")
        ...
        <table class="corp-table">
            ...
            <tr>
                <td><strong>RFID Data Transfer Workflow</strong></td>
                <td class="highlight-adv">Instantaneous RFID read upon sleeve approach. Press is ready immediately after mounting (0 delay).</td>
                <td class="highlight-mid">Requires mounting all sleeves, closing the machine, and running a 10-minute scan cycle (Prone to failures).</td>
            </tr>
            <tr>
        ...
        st.markdown("""يعتمد كل من نظام SOMA IRIS ونظام BOBST smartGPS على **شرائح RFID ومغانط** مدمجة في السليفات لنقل بيانات المونتاج إلى المطبعة. لكن الفارق الجوهري والخطير يكمن في **طريقة أخذ القياسات الفعلية (Measurement)** أثناء مرحلة التجهيز، و **طريقة وتوقيت نقل البيانات إلى المطبعة.**""")
        ...
        <table class="corp-table">
            ...
            <tr>
                <td><strong>طريقة وتوقيت نقل البيانات</strong></td>
                <td class="highlight-adv">مبتكرة: يقرأ الشريحة بمجرد اقتراب السليف قبل التركيب. لا يوجد تأخير، جاهزية فورية للتشغيل.</td>
                <td class="highlight-mid">رحلة طويلة: يتطلب تركيب السليفات وإغلاق الماكينة ثم بدء دورة بحث تستغرق 10 دقائق (تتعرض للفشل أحياناً).</td>
            </tr>
            <tr>
...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Machine Frame Material</strong></td><td class="highlight-adv" style="text-align: center;">130 mm Cast-Iron (Doubled)</td><td style="text-align: center;">100 mm Cast-Iron</td><td style="text-align: center;">55 - 60 mm Steel</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Printing Deck Capping</strong></td><td class="highlight-adv" style="text-align: center;">✅ Fully Auto (High-Tech)</td><td style="text-align: center;">❌ Complex (Screws/Doors)</td><td style="text-align: center;">✅ Automatic</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>Anilox Circumference/OD</strong></td><td class="highlight-adv" style="text-align: center;">625 mm</td><td style="text-align: center;">630 mm</td><td style="text-align: center;">~500 mm (OD: 159.1 mm)</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">Critical Specification</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">The Winner 🏆</th></tr>
            <tr><td><strong>Viscosity Control (2 Liquids)</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES (Dual Liquid)</td><td style="text-align: center;">❌ NO (1 Liquid Only)</td><td style="text-align: center;">❌ NO (1 Liquid Only)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Ink/Solvent Level Sensors</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ Optional</td><td style="text-align: center;">❌ Optional</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Water Cooling on Drive Side</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ NO</td><td style="text-align: center;">❌ NO</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Heat Exchanger (Ink Cooling)</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES</td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ Optional</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            ...
            <tr><td><strong>Drying Tunnel Length</strong></td><td class="highlight-adv" style="text-align: center;">6.0 Meters (23 Nozzles)</td><td style="text-align: center;">4.5 Meters</td><td style="text-align: center;">5.7 Meters (17 Nozzles)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Deep Wash (Time / Solvent)</strong></td><td class="highlight-adv" style="text-align: center;">10 mins / 15 Liters</td><td style="text-align: center;">10 mins / 16 Liters</td><td style="text-align: center;">4 mins / 16 Liters</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Printing Unit Calibration</strong></td><td class="highlight-adv" style="text-align: center;">✅ Fully Auto (Zero Tools/Labor)</td><td style="text-align: center;">❌ Periodic Manual (Needs Tools)</td><td style="text-align: center;">❌ Manual</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>RFID Data Transfer Workflow</strong></td><td class="highlight-adv" style="text-align: center;">✅ Instant Pre-mount Read</td><td style="text-align: center;">❌ ~10 Min Scan Cycle (Post-mount)</td><td style="text-align: center;">❌ Not Available</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>Reprint / Insetter Capability</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES</td><td style="text-align: center;">⚠️ Optional Upgrade (~10k)</td><td style="text-align: center;">⚠️ Optional Upgrade (~10k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Fire Extinguishing System</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES</td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ Optional</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>Lifting Carts (Unwind/Rewind)</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES</td><td style="text-align: center;">⚠️ Optional Upgrade</td><td style="text-align: center;">⚠️ Optional Upgrade</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Antistatic Units (Total)</strong></td><td class="highlight-adv" style="text-align: center;">2 Units (4 Bars)</td><td style="text-align: center;">2 Units (4 Bars)</td><td style="text-align: center;">2 Units (4 Bars)</td><td class="winner-cell-tie">Standard Tie</td></tr>
            <tr><td><strong>100% Inspection Camera</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included (BST)</td><td style="text-align: center;">⚠️ Optional Upgrade (~70k)</td><td style="text-align: center;">⚠️ Optional Upgrade (~71k)</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">Critical Specification</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">The Winner 🏆</th></tr>
            <tr><td><strong>Training Program</strong></td><td class="highlight-adv" style="text-align: center;">10 Days + 2 Weeks + 1 Month</td><td style="text-align: center;">5 Days Only</td><td style="text-align: center;">❌ Optional (5 Days)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>3" & 6" Cores Included</strong></td><td class="highlight-adv" style="text-align: center;">✅ YES (Both Included)</td><td style="text-align: center;">⚠️ 3" Only</td><td style="text-align: center;">⚠️ 3" Only</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Initial Sleeves (8)</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included</td><td style="text-align: center;">❌ No (~55k)</td><td style="text-align: center;">❌ No (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Corona + In-feed Unit</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included</td><td style="text-align: center;">⚠️ Optional Upgrade (~55k)</td><td style="text-align: center;">⚠️ Optional Upgrade (~55k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Out-feed Unit</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included</td><td style="text-align: center;">⚠️ Optional Upgrade</td><td style="text-align: center;">⚠️ Optional Upgrade</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>ALU/PE Handling Kit</strong></td><td class="highlight-adv" style="text-align: center;">✅ Included</td><td style="text-align: center;">⚠️ Optional Upgrade (~50k)</td><td style="text-align: center;">⚠️ Optional Upgrade (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Process Visibility (Glass)</strong></td><td class="highlight-adv" style="text-align: center;">✅ Full Glass</td><td style="text-align: center;">⚠️ Partial</td><td style="text-align: center;">❌ Closed</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        st.markdown("""
        <table class="corp-table">
            <tr><th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th></tr>
            <tr><td><strong>السرعة الإنتاجية القصوى</strong></td><td class="highlight-adv" style="text-align: center;">600 متر/دقيقة</td><td style="text-align: center;">500 متر/دقيقة</td><td style="text-align: center;">500 متر/دقيقة</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>نطاق تكرار الطباعة (Repeat)</strong></td><td class="highlight-adv" style="text-align: center;">360 - 850 ملم (إلى 900)</td><td style="text-align: center;">370 - 800 ملم</td><td style="text-align: center;">370 - 800 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>نطاق شد الرول (Web Tension)</strong></td><td class="highlight-adv" style="text-align: center;">10 - 400 N (نطاق أوسع)</td><td style="text-align: center;">20 - 350 N</td><td style="text-align: center;">20 - 350 N</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>مادة وسماكة الهيكل (Frame)</strong></td><td class="highlight-adv" style="text-align: center;">حديد زهر 130 ملم (مزدوج)</td><td style="text-align: center;">حديد زهر 100 ملم</td><td style="text-align: center;">صلب 55 - 60 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>إغلاق وحدات الطباعة (Capping)</strong></td><td class="highlight-adv" style="text-align: center;">✅ آلي بالكامل (تقنية عالية)</td><td style="text-align: center;">❌ معقد (براغي وصيانة دورية)</td><td style="text-align: center;">✅ آلي</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أعمدة شد خفيفة الوزن (Shafts)</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم (مضيئة 3 و 6 إنش)</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أعمدة كاربون فايبر للطباعة</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">⚠️ ترقية اختيارية</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>القطر الخارجي لعمود الأنيلوكس</strong></td><td class="highlight-adv" style="text-align: center;">175.1 ملم (استقرار مطلق)</td><td style="text-align: center;">172.0 ملم</td><td style="text-align: center;">136.989 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>محيط أسطوانة الأنيلوكس / OD</strong></td><td class="highlight-adv" style="text-align: center;">625 ملم</td><td style="text-align: center;">630 ملم</td><td style="text-align: center;">~500 ملم (OD: 159.1 ملم)</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th></tr>
            <tr><td><strong>التحكم باللزوجة (لنوعين من السوائل)</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم (مزدوج)</td><td style="text-align: center;">❌ لا (سائل واحد فقط)</td><td style="text-align: center;">❌ لا (سائل واحد فقط)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>حساسات مستوى الحبر والمذيبات</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ اختياري</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>التبريد المائي من جهة الإدارة</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ لا</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>مبادل حراري لتبريد الحبر</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ ترقية اختيارية</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            ...
            <tr><td><strong>طول نفق التجفيف</strong></td><td class="highlight-adv" style="text-align: center;">6.0 أمتار (23 فوهة)</td><td style="text-align: center;">4.5 متر</td><td style="text-align: center;">5.7 متر (17 فوهة)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>دورة الغسيل العميق (وقت/استهلاك)</strong></td><td class="highlight-adv" style="text-align: center;">10 دقائق / 15 لتر</td><td style="text-align: center;">10 دقائق / 16 لتر</td><td style="text-align: center;">4 دقائق / 16 لتر</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th></tr>
            <tr><td><strong>مجهزة للأنظمة الذكية (مشمول بالسعر)</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم (مشمول)</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أتمتة الضغوط والتطابق</strong></td><td class="highlight-adv" style="text-align: center;">✅ آلي بالكامل (مع ماونتر IRIS)</td><td style="text-align: center;">⚠️ شبه آلي (Smart-SET)</td><td style="text-align: center;">❌ شبه آلي</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>معايرة وحدات الطباعة (Calibration)</strong></td><td class="highlight-adv" style="text-align: center;">✅ آلي بالكامل (بدون أدوات/تدخل)</td><td style="text-align: center;">❌ يدوي دوري (يحتاج أدوات)</td><td style="text-align: center;">❌ يدوي</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>طريقة نقل بيانات السليف (RFID)</strong></td><td class="highlight-adv" style="text-align: center;">✅ قراءة فورية قبل التركيب (0 تأخير)</td><td style="text-align: center;">❌ فحص متأخر لـ 10 دقائق (معرض للفشل)</td><td style="text-align: center;">❌ غير متوفر</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>نظام إخراج السليفات</strong></td><td class="highlight-adv" style="text-align: center;">✅ دفع آلي (Push-off)</td><td style="text-align: center;">❌ لا / شبه آلي</td><td style="text-align: center;">⚠️ طاردات أساسية</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>تجهيز الطباعة المتكررة (Insetter)</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">⚠️ ترقية اختيارية (~10k)</td><td style="text-align: center;">⚠️ ترقية اختيارية (~10k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>نظام إطفاء الحرائق</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ اختياري</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            <tr><td><strong>رافعات رولات للفك واللف</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم</td><td style="text-align: center;">⚠️ ترقية اختيارية</td><td style="text-align: center;">⚠️ ترقية اختيارية</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>وحدات منع الكهرباء الساكنة</strong></td><td class="highlight-adv" style="text-align: center;">وحدتين (4 بارات)</td><td style="text-align: center;">وحدتين (4 بارات)</td><td style="text-align: center;">وحدتين (4 بارات)</td><td class="winner-cell-tie">تعادل قياسي</td></tr>
            <tr><td><strong>كاميرا فحص الجودة 100%</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة (BST)</td><td style="text-align: center;">⚠️ ترقية اختيارية (~70k)</td><td style="text-align: center;">⚠️ ترقية اختيارية (~71k)</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            <tr><th style="width: 25%;">المواصفة الحيوية (المشمولة بالسعر)</th><th style="width: 25%; text-align: center;">SOMA Optima 2</th><th style="width: 25%; text-align: center;">BOBST Expert CI</th><th style="width: 25%; text-align: center;">W&H Alphaflex</th><th style="width: 15%; text-align: center; background-color: #059669;">الشركة الفائزة 🏆</th></tr>
            <tr><td><strong>برنامج تدريب المشغلين</strong></td><td class="highlight-adv" style="text-align: center;">10 أيام + أسبوعين + شهر</td><td style="text-align: center;">5 أيام فقط</td><td style="text-align: center;">❌ اختياري (5 أيام)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>محاور مقاس 3 و 6 إنش (Cores)</strong></td><td class="highlight-adv" style="text-align: center;">✅ نعم (كلاهما مشمول)</td><td style="text-align: center;">⚠️ 3 إنش فقط</td><td style="text-align: center;">⚠️ 3 إنش فقط</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أطقم السليفات المبدئية (8)</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">❌ لا (~55k)</td><td style="text-align: center;">❌ لا (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>وحدة كورونا + وحدة سحب (In-feed)</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">⚠️ ترقية اختيارية (~55k)</td><td style="text-align: center;">⚠️ ترقية اختيارية (~55k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>وحدة السحب بعد الطباعة (Out-feed)</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة</td><td style="text-align: center;">⚠️ ترقية اختيارية</td><td style="text-align: center;">⚠️ ترقية اختيارية</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>تجهيزات طباعة ALU و PE</strong></td><td class="highlight-adv" style="text-align: center;">✅ مشمولة بالكامل</td><td style="text-align: center;">⚠️ ترقية اختيارية (~50k)</td><td style="text-align: center;">⚠️ ترقية اختيارية (~50k)</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>رؤية وشفافية وحدات الطباعة</strong></td><td class="highlight-adv" style="text-align: center;">✅ زجاج شفاف بالكامل</td><td style="text-align: center;">⚠️ أغطية جزئية</td><td style="text-align: center;">❌ مغلقة (انعدام الرؤية)</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
