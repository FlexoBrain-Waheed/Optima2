...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Machine Frame Material</strong></td><td class="highlight-adv">130 mm Cast-Iron (Vibration absorbing)</td><td class="highlight-mid">100 mm</td><td class="highlight-dis">55-60 mm Steel</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>مادة جدار الهيكل وسماكته</strong></td><td class="highlight-adv">حديد زهر (Cast-Iron) بسماكة 130 ملم</td><td class="highlight-mid">100 ملم</td><td class="highlight-dis">حديد صلب 55-60 ملم</td></tr>
...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>Fast Wash Solvent Usage</strong></td><td class="highlight-adv" style="text-align: center;">5 Liters</td><td style="text-align: center;">Standard</td><td style="text-align: center;">12 Liters</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>مادة وسماكة الهيكل (Frame)</strong></td><td class="highlight-adv" style="text-align: center;">حديد زهر 130 ملم (مزدوج)</td><td style="text-align: center;">100 ملم</td><td style="text-align: center;">صلب 55 - 60 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>قطر عمود الأنيلوكس الأساسي</strong></td><td class="highlight-adv" style="text-align: center;">175.1 ملم (استقرار مطلق)</td><td style="text-align: center;">172.0 ملم</td><td style="text-align: center;">136.989 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>هدر المذيبات في الغسيل السريع</strong></td><td class="highlight-adv" style="text-align: center;">5 لتر فقط</td><td style="text-align: center;">استهلاك قياسي</td><td style="text-align: center;">12 لتر (هدر عالي)</td><td class="winner-cell">SOMA 🏆</td></tr>
        </table>
        """, unsafe_allow_html=True)
