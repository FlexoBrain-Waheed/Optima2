...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td><strong>كاميرا فحص الجودة 100%</strong></td><td class="highlight-adv">✔️ مشمولة (BST iPQ Check)</td><td class="highlight-mid">إضافة اختيارية غالباً</td><td class="highlight-dis">➖ إضافة اختيارية</td></tr>
...
# ==========================================
    ...
    if lang == "English":
        ...
        <table class="corp-table">
            ...
            <tr><td rowspan="7" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">1. Core Mechanics & Dimensions</td><td><strong>Max Production Speed</strong></td><td style="text-align: center;">600 m/min</td><td style="text-align: center;">500 m/min</td><td style="text-align: center;">500 m/min</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>Frame Wall Thickness</strong></td><td style="text-align: center;">130 mm (Doubled)</td><td style="text-align: center;">Standard</td><td style="text-align: center;">55 - 60 mm</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Lightweight Winding Shafts</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ Optional</td><td style="text-align: center;">❌ NO</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">3. Automation & Safety</td><td><strong>Prepared for Smart System</strong></td><td style="text-align: center;">✅ YES (IRIS)</td><td style="text-align: center;">✅ YES (smartGPS)</td><td style="text-align: center;">❌ NO</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            ...
            <tr><td><strong>Lifting Carts (Unwind & Rewind)</strong></td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">✅ YES</td><td style="text-align: center;">❌ NO</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            ...
            <tr><td><strong>100% Inspection Camera</strong></td><td style="text-align: center;">✅ Included (BST)</td><td style="text-align: center;">❌ Optional</td><td style="text-align: center;">❌ Optional</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td rowspan="5" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">4. OPEX & Peripherals</td><td><strong>3" & 6" Cores Included</strong></td><td style="text-align: center;">✅ YES (Both Included)</td><td style="text-align: center;">⚠️ 3" Only</td><td style="text-align: center;">⚠️ 3" Only</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>Initial Sleeves (8+8)</strong></td><td style="text-align: center;">✅ Included (Standard)</td><td style="text-align: center;">⚠️ Requires costly smartGPS</td><td style="text-align: center;">❌ Not Included</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>ALU/PE Handling Kit</strong></td><td style="text-align: center;">✅ Included</td><td style="text-align: center;">❌ Optional</td><td style="text-align: center;">❌ Not Included</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>Warranty Period</strong></td><td style="text-align: center;">12 Months</td><td style="text-align: center;">12 Months</td><td style="text-align: center;">12 Months</td><td class="winner-cell-tie">Standard Tie</td></tr>
        </table>
        """, unsafe_allow_html=True)
    else:
        st.markdown('<div class="executive-title">10. المواجهة الشاملة: ما تدفعه مقابل ما تحصل عليه فعلياً 🏆</div>', unsafe_allow_html=True)
        st.markdown("""توضح هذه المصفوفة القيمة الحقيقية لكل عرض مالي من خلال مقارنة المواصفات الأساسية المشمولة في السعر (Standard Equipment). تقدم SOMA ماكينة جاهزة تماماً للأداء العالي (Fully-loaded)، بينما يقدم المنافسون هياكل تتطلب ترقيات باهظة.""")
        ...
        <table class="corp-table">
            ...
            <tr><td rowspan="7" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">1. الهيكل الميكانيكي والأبعاد</td><td><strong>السرعة الإنتاجية القصوى</strong></td><td style="text-align: center;">600 متر/دقيقة</td><td style="text-align: center;">500 متر/دقيقة</td><td style="text-align: center;">500 متر/دقيقة</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>سماكة جدار الهيكل (Frame)</strong></td><td style="text-align: center;">130 ملم (مزدوج)</td><td style="text-align: center;">قياسي</td><td style="text-align: center;">55 - 60 ملم</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أعمدة شد خفيفة الوزن (Shafts)</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ لا</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td rowspan="6" style="vertical-align: middle; font-weight: bold; background-color: #F8FAFC;">3. الأتمتة وأنظمة الأمان</td><td><strong>مجهزة للأنظمة الذكية (IRIS/GPS)</strong></td><td style="text-align: center;">✅ نعم (IRIS)</td><td style="text-align: center;">✅ نعم (smartGPS)</td><td style="text-align: center;">❌ لا</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            ...
            <tr><td><strong>رافعة رولات للفك واللف</strong></td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">✅ نعم</td><td style="text-align: center;">❌ لا</td><td class="winner-cell-shared">SOMA & BOBST</td></tr>
            ...
            <tr><td><strong>كاميرا فحص الجودة 100%</strong></td><td style="text-align: center;">✅ مشمولة (BST)</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ اختياري</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td rowspan="5" style="vertical-align: middle; font-weight: bold; background-color: #F1F5F9;">4. التكاليف التشغيلية (OPEX)</td><td><strong>محاور مقاس 3 و 6 إنش (Cores)</strong></td><td style="text-align: center;">✅ نعم (كلاهما مشمول)</td><td style="text-align: center;">⚠️ 3 إنش فقط</td><td style="text-align: center;">⚠️ 3 إنش فقط</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>أطقم السليفات المبدئية (8+8)</strong></td><td style="text-align: center;">✅ مشمولة (قياسية)</td><td style="text-align: center;">⚠️ تتطلب شراء smartGPS مكلفة</td><td style="text-align: center;">❌ غير مشمولة</td><td class="winner-cell">SOMA 🏆</td></tr>
            <tr><td><strong>تجهيزات طباعة ALU و PE</strong></td><td style="text-align: center;">✅ مشمولة بالكامل</td><td style="text-align: center;">❌ اختياري</td><td style="text-align: center;">❌ غير مشمولة</td><td class="winner-cell">SOMA 🏆</td></tr>
            ...
            <tr><td><strong>فترة الضمان الإجمالية</strong></td><td style="text-align: center;">12 شهراً</td><td style="text-align: center;">12 شهراً</td><td style="text-align: center;">12 شهراً</td><td class="winner-cell-tie">تعادل قياسي</td></tr>
        </table>
        """, unsafe_allow_html=True)
