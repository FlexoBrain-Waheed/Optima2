...
# ==========================================
# Page 3: Operational Efficiency (Wash-up & Ink) - NEW DESIGN
# ==========================================
    ...
    if lang == "English":
        ...
        st.write("SOMA’s intelligent fluid management systems are engineered to drastically slash daily consumable waste (Solvents & High-pigment Inks), turning operational savings into direct bottom-line profit.")
        ...
        st.write("تم تصميم أنظمة إدارة السوائل الذكية في SOMA لخفض الهدر اليومي في المواد الاستهلاكية (المذيبات والأحبار عالية التكلفة) بشكل جذري، مما يحول التوفير التشغيلي إلى أرباح مباشرة للمصنع.")
...
# ==========================================
    ...
    if lang == "English":
        ...
        st.write("نحن في SOMA لا نبيع مجرد ماكينة مفردة، بل نبني لك مصنعاً متكاملاً بأعلى درجات التوافق التكنولوجي. شراء الح
